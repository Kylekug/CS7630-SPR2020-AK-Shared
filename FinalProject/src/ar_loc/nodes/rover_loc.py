...
from ar_loc.rover_kf import *
from ar_loc.rover_pf import *
from ar_loc.rover_odo import *
...
class RoverLoc:
    ...
    def compass_cb(self, value):
        ...
        #self.filter.publish(self.pose_pub,self.pose_with_cov_pub,"/world",rospy.Time.now())
