...
from face_detect_base.msg import FaceArray
...
if __name__ == '__main__':
    pub1 = rospy.Publisher("faceROIArray", FaceArray, queue_size=10)
    pub2 = rospy.Publisher("faceImage", sensor_msgs.msg.Image, queue_size=10)
    ...
    def detect_and_draw(imgmsg):
        ...
        for (x,y,w,h) in faces:
            ROI_dummy.append(sensor_msgs.msg.RegionOfInterest(x,y,w,h,False))
